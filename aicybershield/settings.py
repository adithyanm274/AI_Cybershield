"""
Django settings for aicybershield project.
"""
import os
import mimetypes
...
INSTALLED_APPS = [
    ...
    'organizationregister.apps.OrganizationregisterConfig',
    'quiz.apps.QuizConfig',
    'register.apps.RegisterConfig',
    'securityrecommendation.apps.SecurityrecommendationConfig',
...
ROOT_URLCONF = 'aicybershield.urls'
...
WSGI_APPLICATION = 'aicybershield.wsgi.application'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')   # ← FIXED (was pointing to 'static')
